...
```astro
---
const githubUrl = 'https://github.com/Storm-razor/Claw-Understand-Anything';
---
...
<section class="install" id="install">
  <div class="install-inner reveal">
    ...
    <div class="install-code">
      ...
      <pre><code><span class="cmd">/plugin marketplace add</span> Storm-razor/Claw-Understand-Anything
...
```markdown
**[Homepage](https://understand-anything.com)** | **[GitHub](https://github.com/Storm-razor/Claw-Understand-Anything)**
```
