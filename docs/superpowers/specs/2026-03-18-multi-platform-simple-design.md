...
```
Fetch and follow instructions from https://raw.githubusercontent.com/Storm-razor/Claw-Understand-Anything/refs/heads/main/understand-anything-plugin/.codex/INSTALL.md
```
