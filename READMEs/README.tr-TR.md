...
<p align="center">
  ...
  <a href="https://github.com/Storm-razor/Claw-Understand-Anything/blob/main/LICENSE"><img src="https://img.shields.io/badge/Lisans-MIT-yellow" alt="Lisans: MIT" /></a>
...
Otomatik keşif çalışmazsa manuel kur: **Cursor Settings → Plugins**'i aç, arama alanına `https://github.com/Storm-razor/Claw-Understand-Anything` yapıştır ve oradan ekle.
...
<a href="https://www.star-history.com/?repos=Egonex-AI%2FUnderstand-Anything&type=date&legend=top-left">
 <picture>
   ...
   <img alt="Star Geçmişi Grafiği" src="https://api.star-history.com/image?repos=Storm-razor/Claw-Understand-Anything&type=date&legend=top-left" />
 </picture>
</a>
