...
<p align="center">
  ...
  <a href="https://github.com/Storm-razor/Claw-Understand-Anything/blob/main/LICENSE"><img src="https://img.shields.io/badge/라이선스-MIT-yellow" alt="License: MIT" /></a>
...
자동 인식이 되지 않으면 수동으로 설치하세요: **Cursor Settings → Plugins**를 열고 검색란에 `https://github.com/Storm-razor/Claw-Understand-Anything`를 붙여넣은 뒤 추가하세요.
