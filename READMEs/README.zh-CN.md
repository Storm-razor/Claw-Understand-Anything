...
<p align="center">
  ...
  <a href="https://github.com/Storm-razor/Claw-Understand-Anything/blob/main/LICENSE"><img src="https://img.shields.io/badge/许可证-MIT-yellow" alt="License: MIT" /></a>
...
若自动发现未生效，可手动安装：打开 **Cursor Settings → Plugins**，在搜索框中粘贴 `https://github.com/Storm-razor/Claw-Understand-Anything` 并添加。
